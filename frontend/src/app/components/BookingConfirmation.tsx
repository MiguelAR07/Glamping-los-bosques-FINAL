          ...
          <div className="px-8 py-10 border-b lg:border-b-0 lg:border-r border-stone-100 bg-stone-50/50">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-stone-500">{planType}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
            ...
            <div className="bg-white p-5 rounded-2xl border border-stone-200 shadow-sm">
              ...
              <div className="flex justify-between items-end">
                ...
                <span className="text-3xl font-black text-emerald-700">${formatCOP(deposit)}</span>
              </div>
              <p className="text-xs text-stone-400 mt-2 text-right">Saldo restante: ${formatCOP(total - deposit)}</p>
            </div>
          </div>
