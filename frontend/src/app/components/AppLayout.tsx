      ...
      <header className="fixed w-full z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-8 lg:gap-12">
            ...
            <nav className="hidden lg:flex items-center gap-6 lg:gap-8 font-medium text-stone-600">
              ...
              <a href="/#promociones" onClick={(e) => handleSectionClick(e, 'promociones')} className="hover:text-emerald-700 transition-colors flex items-center gap-1 whitespace-nowrap">Promociones</a>
